...
exports.createCheckoutSession = functions.https.onCall(async (data, context) => {
    ...
    // Define coin packages (production pricing)
    const packages = {
        ...
        'coins_10': { amount: 13500, coins: 10, description: '10 Coins (10% off)' },
        'coins_20': { amount: 24000, coins: 20, description: '20 Coins (20% off)' }
    };
